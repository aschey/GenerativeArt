...
function Scribble() {
    ...
    this.buildEllipse = function( cx, cy, rx, ry, offset, overlap, graphics ) {
        var radialOffset = this.getOffset( -0.5, 0.5 )-Math.PI/2;
  
        let points = [
            this.getOffset( -offset, offset )+cx+0.9*rx*Math.cos( radialOffset-this.ellipseInc ),
        ...
        points.push(this.getOffset( -offset, offset )+cx+rx*Math.cos( radialOffset+Math.PI*2+overlap*0.5 ));
        points.push(this.getOffset( -offset, offset )+cy+ry*Math.sin( radialOffset+Math.PI*2+overlap*0.5 ) );
        points.push( this.getOffset( -offset, offset )+cx+0.98*rx*Math.cos( radialOffset+overlap ));
        points.push(this.getOffset( -offset, offset )+cy+0.98*ry*Math.sin( radialOffset+overlap ) );
        points.push(this.getOffset( -offset, offset )+cx+0.9*rx*Math.cos( radialOffset+overlap*0.5 ));
        points.push(this.getOffset( -offset, offset )+cy+0.9*ry*Math.sin( radialOffset+overlap*0.5 ) );
        drawCurve(points);
    }
    ...
    this.scribbleLine = function(graphics, x1, y1, x2, y2 ) {
      ...
      drawCurve(graphics, [
        [x1 + this.getOffset( -offset, offset ), y1 + this.getOffset( -offset, offset )],
        [midDispX+x1+(x2 -x1)*divergePoint + this.getOffset( -offset, offset ), midDispY+y1 + (y2-y1)*divergePoint + this.getOffset( -offset, offset )],
        [midDispX+x1+2*(x2-x1)*divergePoint + this.getOffset( -offset, offset ), midDispY+y1+ 2*(y2-y1)*divergePoint + this.getOffset( -offset,offset )],
        [x2 + this.getOffset( -offset, offset ), y2 + this.getOffset( -offset, offset )]
      ]);
      
      drawCurve(graphics, [
        [x1 + this.getOffset( -halfOffset, halfOffset ), y1 + this.getOffset( -halfOffset, halfOffset )],
        [midDispX+x1+(x2 -x1)*divergePoint + this.getOffset( -halfOffset, halfOffset ), midDispY+y1 + (y2-y1)*divergePoint + this.getOffset( -halfOffset, halfOffset )],
        [ midDispX+x1+2*(x2-x1)*divergePoint + this.getOffset( -halfOffset, halfOffset ), midDispY+y1+ 2*(y2-y1)*divergePoint + this.getOffset( -halfOffset, halfOffset )],
        [x2 + this.getOffset( -halfOffset, halfOffset ), y2 + this.getOffset( -halfOffset, halfOffset )]
      ]);
    }
